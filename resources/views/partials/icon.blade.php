...
$icons = [
    ...
    'image-off' => '<path d="m2 2 20 20" /> <path d="M10.41 10.41a2 2 0 1 1-2.83-2.83" /> <path d="m14.5 14.5-7.08 5.21a1 1 0 0 1-1.57-.5L2.1 12.6a1 1 0 0 1 .57-1.32L6 9.91" /> <path d="M19.57 17.15 21 16.1a1 1 0 0 0 .32-1.34L15.6 5.6A2 2 0 0 0 13.9 4.5H8.8" /> <path d="M3 6.5V5a2 2 0 0 1 2-2h10" /> <path d="M2 6.5V16a2 2 0 0 0 2 2h12a2 2 0 0 0 1.9-1.4" />',
];
@endphp
@if(isset($icons[$name]))
